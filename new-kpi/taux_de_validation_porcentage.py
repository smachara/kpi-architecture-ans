...
plt.plot(pivot_df.index, pivot_df['FINESS+'], marker='o', label='FINESS+ - Validation Rate')
plt.plot(pivot_df.index, pivot_df['MaCertifPS'], marker='o', label='MaCertifPS - Validation Rate')
...
plt.figure(figsize=(12, 6))
plt.plot(pivot_requested_validated.index, pivot_requested_validated['FINESS+'], marker='o', label='FINESS+ - Requested vs Validated')
plt.plot(pivot_requested_validated.index, pivot_requested_validated['MaCertifPS'], marker='o', label='MaCertifPS - Requested vs Validated')
